...
_CONFIGPROTO_EXPERIMENTAL = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fetch_remote_devices_in_multi_client', full_name='tensorboard.ConfigProto.Experimental.fetch_remote_devices_in_multi_client', index=18,
