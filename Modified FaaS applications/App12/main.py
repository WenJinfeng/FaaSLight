...
print ("loaded done!")
tm_2 = datetime.datetime.now()
print(',initStart:{},'.format(tm_1))
print(',initEnd:{},'.format(tm_2))
...
# print(predict({'queryStringParameters':{'x': 3.44}},{}))
